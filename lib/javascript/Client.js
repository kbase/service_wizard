...
function ServiceWizard(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.version = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "ServiceWizard.version",
     ...
     this.start = function (service, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "ServiceWizard.start",
     ...
     this.stop = function (service, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax(_url, "ServiceWizard.stop",
            [service], 1, _callback, _errorCallback);
    };
     ...
     this.list_service_status = function (params, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax(_url, "ServiceWizard.list_service_status",
     ...
     this.get_service_status = function (service, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax(_url, "ServiceWizard.get_service_status",
            [service], 1, _callback, _errorCallback);
    };
     ...
     this.get_service_status_without_restart = function (service, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax(_url, "ServiceWizard.get_service_status_without_restart",
            [service], 1, _callback, _errorCallback);
    };
     ...
     this.get_service_log = function (params, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax(_url, "ServiceWizard.get_service_log",
            [params], 1, _callback, _errorCallback);
    };
     ...
     this.get_service_log_web_socket = function (params, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax(_url, "ServiceWizard.get_service_log_web_socket",
            [params], 1, _callback, _errorCallback);
    };
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "ServiceWizard.status",
            [], 1, _callback, _errorCallback);
    };
